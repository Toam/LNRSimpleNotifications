...
public class LNRSimpleNotificationView: UIView, UIGestureRecognizerDelegate {
    ...
    */
    ...
    func notificationViewHeightAfterLayoutOutSubviews(padding: CGFloat, notificationWidth: CGFloat) -> CGFloat {
        ...
        self.titleLabel.frame = CGRect(x: textLabelsXPosition, y: topPadding - 20, width: notificationWidth - textLabelsXPosition - padding, height: CGFloat(12.0))
//        self.titleLabel.sizeToFit()
        ...
        self.frame = CGRect(x: CGFloat(0.0), y: self.frame.origin.y, width: self.frame.size.width, height: height - 15)
